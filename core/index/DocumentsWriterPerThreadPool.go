...
// DocumentsWriterPerThreadPool DocumentsWriterPerThreadPool controls DocumentsWriterPerThread instances and
...
// make progress. Depending on the DocumentsWriterPerThreadPool implementation
// DocumentsWriterPerThread assignments might differ from document to document.
// *
// <p>Once a DocumentsWriterPerThread is selected for flush the
