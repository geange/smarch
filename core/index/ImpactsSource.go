...
type ImpactsSource interface {
	...
	// AdvanceShallow Shallow-advance to target}. This is cheaper than calling
	// DocIdSetIterator#advance(int)} and allows further calls to #getImpacts()} to ignore doc
	...
	// DocIdSetIterator#nextDoc()} may not be called if the current doc ID is less than target
	...
	// maximum of DocIdSetIterator#docID()} and the last target that was passed to
